/**
 * Shared NLP & Domain Intelligence Utilities
 * Single Source of Truth for Entity Extraction, Keyword Matching, and Dynamic Title Cleaning.
 * Shared between Server (server.ts, API routes) and Client (src/utils/jev.ts).
 */
