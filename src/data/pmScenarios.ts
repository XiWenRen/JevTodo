...
export const PM_SCENARIO_LIST: PMScenarioDef[] = [
  {
    ...
    rawInput: '生产环境 8080 端口网关告警 502，下午2点前拉通运维与核心开发修复 #502报警 #网关排查',
    expectedCategory: '即刻完成',
    expectedPriority: 'P0',
    expectedTags: ['502报警', '网关排查'],
  ...
  },
  {
    ...
    iconType: 'test',
    title: '核心支付与退款用例评审会',
    rawInput: '今天下午3点组织核心订单与退款测试用例评审，确认冒烟卡点 #用例评审 #冒烟测试',
    expectedCategory: '即刻完成',
    expectedPriority: 'P1',
    expectedTags: ['用例评审', '冒烟测试'],
  ...
  },
  {
    ...
    rawInput: '今天17:00前完成供应链改造需求评审方案并锁定版本PRD #PRD终审 #供应链改造',
    expectedCategory: '即刻完成',
    expectedPriority: 'P1',
    expectedTags: ['PRD终审', '供应链改造'],
  ...
  },
  {
    ...
    rawInput: '下班前跟进结算微服务重构代码CR卡点与灰度发版计划 #代码审查 #灰度发版',
    expectedCategory: '即刻完成',
    expectedPriority: 'P1',
    expectedTags: ['代码审查', '灰度发版'],
  ...
  },
  {
    ...
    rawInput: '明天上午10点组织SaaS项目双周进度例会，评估延期风险并更新燃尽图 #双周例会 #燃尽图',
    expectedCategory: '近期完成',
    expectedPriority: 'P2',
    expectedTags: ['双周例会', '燃尽图'],
  ...
  },
  {
    ...
    rawInput: '本周四前提交AI算力服务器硬件采购申请与3家供应商比价单 #硬件采购 #供应商比价',
    expectedCategory: '近期完成',
    expectedPriority: 'P2',
    expectedTags: ['硬件采购', '供应商比价'],
  ...
  },
  {
    ...
    rawInput: '本周五下班前完成2027财年IT研发与云资源预算申报表 #预算申报 #云资源预算',
    expectedCategory: '近期完成',
    expectedPriority: 'P2',
    expectedTags: ['预算申报', '云资源预算'],
  ...
  },
  {
    ...
    rawInput: '后天下午安排资深架构师候选人技术终面及新员工试用期1on1面谈 #架构师终面 #试用期1on1',
    expectedCategory: '近期完成',
    expectedPriority: 'P2',
    expectedTags: ['架构师终面', '试用期1on1'],
  ...
  },
  {
    ...
    rawInput: '下个月启动新一代分布式中台架构演进立项申请与ROI效益评估预研 #架构演进 #立项预研',
    expectedCategory: '规划待办',
    expectedPriority: 'P3',
    expectedTags: ['架构演进', '立项预研'],
  ...
  },
  {
    ...
    rawInput: '下半年启动同城双活与跨机房灾备迁移总体方案论证与演练规划 #双活灾备 #机房迁移',
    expectedCategory: '规划待办',
    expectedPriority: 'P3',
    expectedTags: ['双活灾备', '机房迁移'],
  ...
  },
  {
    ...
    rawInput: '联系旧机房弱电供应商询问废旧机架回收报价 #弱电询价 #机架回收',
    expectedCategory: '规划待办',
    expectedPriority: 'P3',
    expectedTags: ['弱电询价', '机架回收'],
  ...
  return [
    {
      ...
      rawInput: '生产环境 8080 端口网关告警 502，拉通运维与核心开发排查修复 #502报警 #网关排查',
      category: '即刻完成',
      priority: 'P0',
      urgencyScore: 0.98,
      tags: ['502报警', '网关排查'],
    ...
    },
    {
      ...
      rawInput: '今天组织核心订单与退款测试用例评审，确认冒烟卡点 #用例评审 #冒烟测试',
      category: '即刻完成',
      priority: 'P1',
      urgencyScore: 0.92,
      tags: ['用例评审', '冒烟测试'],
    ...
    },
    {
      ...
      rawInput: '完成供应链改造需求评审方案并锁定版本PRD #PRD终审 #供应链改造',
      category: '即刻完成',
      priority: 'P1',
      urgencyScore: 0.89,
      tags: ['PRD终审', '供应链改造'],
    ...
    },
    {
      ...
      rawInput: '跟进结算微服务重构代码CR卡点与灰度发版计划 #代码审查 #灰度发版',
      category: '即刻完成',
      priority: 'P1',
      urgencyScore: 0.85,
      tags: ['代码审查', '灰度发版'],
    ...
    },
    {
      ...
      rawInput: '查阅 2024 年老旧微服务测试用例历史归档目录 #历史归档 #用例查阅',
      category: '规划待办',
      priority: 'P3',
      urgencyScore: 0.1,
      tags: ['历史归档', '用例查阅'],
