...
export function generatePMSimulatedTasks(): TaskItem[] {
  ...
  return [
    {
      id: 'pm-task-1',
      title: '生产环境 8080 端口网关告警 502，下午2点前拉通运维排查修复',
      rawInput: '生产环境 8080 端口网关告警 502，下午2点前拉通运维与核心开发修复 #运维 #生产',
      category: '即刻完成',
      priority: 'P0',
      urgencyScore: 0.98,
      tags: ['运维', '生产'],
      dueDate: '今天 14:00',
      dueDateIso: new Date(now + ONE_HOUR * 2).toISOString(),
      completed: false,
    ...
    },
    {
      ...
      tags: ['测试', '评审'],
      dueDate: '今天 15:00',
      dueDateIso: new Date(now + ONE_HOUR * 3).toISOString(),
      completed: false,
    ...
    },
    {
      ...
      tags: ['需求', '产品'],
      dueDate: '今天 17:00',
      dueDateIso: new Date(now + ONE_HOUR * 5).toISOString(),
      completed: false,
    ...
    {
      id: 'pm-task-4',
      title: '下班前跟进结算微服务重构代码 CR 卡点与灰度发版计划',
      rawInput: '下班前跟进结算微服务重构代码CR卡点与灰度发版计划 #研发 #进度',
      category: '即刻完成',
      priority: 'P1',
      urgencyScore: 0.85,
      tags: ['研发', '进度'],
      dueDate: '今天 18:30',
      dueDateIso: new Date(now + ONE_HOUR * 6.5).toISOString(),
      completed: false,
